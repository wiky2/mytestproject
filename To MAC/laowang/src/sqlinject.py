#python脚本写的SQL注入漏洞扫描工具，支持批量扫描。07年的程序，程序仅用单引号测试是否存在SQL#注入漏洞，对过滤了单引号的情况就无能为力了。
...
# This script was written by houbysoft   

#(visit http://houbysoft.com/ for more info), (c) 2009.  

# Thanks to : low1z for the list of   

# SQL injection error messages and their respective databases,  

# d3hydr8 for making such a nice forum and   

#all forum.darkc0de.com members and you, the user!  
...
def usage():  
    ...
    print "[h]     cmd   : the command to execute on each vulnerable URL found\  

                . %url% will be replaced by the vulnerable URL"  
