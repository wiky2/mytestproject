...
def loginYahoo(username, password):
    ...
    data0 = response.read()
    data0 = data0.decode('utf-8').encode('gb18030 ')#������ʱ��utf8�����str,�ȴ�ɢ��unicode������gb18030 ���б���ɺ��֡�
    print type(data0)
...
#    response = urllib2.urlopen(url1)
    data2 =response.read()
    print data2.decode('utf-8').encode('gb18030 ')#������ʱ��utf8�����str,�ȴ�ɢ��unicode������gb18030 ���б���ɺ��֡�
    ...
    for i in xrange(num_times):
        ...
        data3 = response.read()
        data3=data3.decode('utf-8').encode('gb18030 ')#������ʱ��utf8�����str,�ȴ�ɢ��unicode������gb18030 ���б���ɺ��֡�
        print data3
        fb=open('data3.txt','w+')
        fb.write(data3)
