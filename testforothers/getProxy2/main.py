...
class getProxy():
    ...
    def check_Proxy_IP(self,proxies):
        ...
        try:
            ...
            s=requests.get(url='http://www.baidu.com',headers=self.header,proxies=proxies,timeout=10)
